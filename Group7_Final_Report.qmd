...
From individuals to the largest corporations in the world: adequately assessing and managing credit risk is paramount. We seek to understand what components make up credit risk to gain a better understanding on how to manage it. Our data consists of several bonds from publicly listed companies and contains predictors that include company fundamentals and sentiment indicators.

\*\* add some key results
...
Our approach will consist on leveraging our domain knowledge along with some key data exploration to select the most appropriate variables for our model.

For continuous variables, we can use scatter plots to try and assess whether relationships exist between our outcome variable and the predictors.

For categorical/ordinal variables we can use histograms and boxplots to aid us in assessing whether each predictor has a clear relationship with our outcome variables.
