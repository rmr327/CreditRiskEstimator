...
1.  Which factors contribute to a bond's credit rating? (Outcome Variable: average_credit_rating) 2. Can we predict a certain bond's credit spread based on various metrics like the company's fundamentals and the market's sentiment related to that company? (Outcome Variable: cedit_spread)
