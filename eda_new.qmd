...
```{r, include=FALSE}
#| echo: false
ggplot(bonds, aes(x = Duration, y = credit_spread, col = Sector)) + 
  geom_point() + 
  geom_smooth(method = 'lm', se = F) + 
  labs(y = 'Credit spread (%)', x = 'Duration')
...
![Credit to Equity](credit_to_equity.png){#fig-equity}
...
![Credit to Asset](credit_to_asset.png){#fig-asset}
